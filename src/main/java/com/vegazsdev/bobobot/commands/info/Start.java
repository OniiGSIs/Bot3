...
public class Start extends Command {
    ...
    public void botReply(Update update, TelegramBot bot, PrefObj prefs) {
        ...
        ListInlineKeyboardButtonChannelBTN.setUrl("https://t.me/OniiGSIVN");
